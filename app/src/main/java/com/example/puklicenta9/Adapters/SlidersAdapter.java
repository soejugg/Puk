...
public class SlidersAdapter extends RecyclerView.Adapter<SlidersAdapter.SliderViewhoder> {
    ...
    @NonNull
    @Override
    public SlidersAdapter.SliderViewhoder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        context=parent.getContext();
        return new SliderViewhoder(LayoutInflater.from(parent.getContext()).inflate(R.layout.slider_viewholder,parent,false));
    }

    @Override
    public void onBindViewHolder(@NonNull SlidersAdapter.SliderViewhoder holder, int position) {
